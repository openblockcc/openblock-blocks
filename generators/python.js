...
Blockly.Python.scrub_ = function(block, code) {
  ...
  // and it is a hat block, and it is not 'microbit_Microbit_whenmicrobitbegin' and  'maixduino_Maixduino_whenmaixduinobegin' block.
  ...
  if (block.getSurroundParent() === null && code !== "" && block.previousConnection !== null
    && block.getTopStackBlock().type !== 'microbit_Microbit_whenmicrobitbegin' 
	&& block.getTopStackBlock().type !== 'maixduino_Maixduino_whenmaixduinobegin' 
	&& block.getTopStackBlock().type !== 'raspberrypico_RaspberryPico_whenraspberrypicobegin') {
